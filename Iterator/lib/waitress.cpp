...
void
Waitress::print_breakfast_menu() const
{
...
void
Waitress::print_lunch_menu() const
{
    std::cout << "\nLunch Menu: \n";
...
void
Waitress::print_vegetarian_menu() const
{
...
bool
Waitress::is_vegeterian(const std::string& name) const
{
    auto itb = m_breakfast_menu->iterator();
    while (itb->has_next())
    {
