...
bool
MenuItem::vegeterian() const
{
    return m_vegetarian;
}

double
MenuItem::price() const
{
    return m_price;
}
#pragma endregion
...
bool
PancakeHouseMenuIterator::has_next() const
{
...
bool
DinerMenuIterator::has_next() const
{
...
void
PancakeHouseMenu::add_menu_item(const MenuItem& menu_item)
{
    m_menu_items.push_back(menu_item);
}

const std::list<MenuItem>&
PancakeHouseMenu::menu_items() const
{
    return m_menu_items;
}
...
void
DinerMenu::add_menu_item(const MenuItem& menu_item)
{
